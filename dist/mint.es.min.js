/*! `mint` grammar compiled for Highlight.js 11.12.0 */
var hljsGrammar=(()=>{"use strict";return e=>{const n=[],a={keywords:{
...
literal:["true","false"]}},s={illegal:/</,relevance:0,endsWithParent:!0,
...
contains:[{begin:/[^\/><\s]+/,className:"name",relevance:0},s]},{
begin:"style\\s+[a-zA-Z0-9-]+\\s*{",end:"}",keywords:a,contains:[{
